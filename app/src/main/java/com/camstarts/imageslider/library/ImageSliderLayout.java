...
import com.camstarts.imageslider.library.transformers.AccordionTransformer;
import com.camstarts.imageslider.library.transformers.BackgroundToForegroundTransformer;
import com.camstarts.imageslider.library.transformers.BaseTransformer;
import com.camstarts.imageslider.library.transformers.CubeInTransformer;
import com.camstarts.imageslider.library.transformers.DefaultTransformer;
import com.camstarts.imageslider.library.transformers.DepthPageTransformer;
import com.camstarts.imageslider.library.transformers.FadeTransformer;
import com.camstarts.imageslider.library.transformers.FlipHorizontalTransformer;
import com.camstarts.imageslider.library.transformers.FlipPageViewTransformer;
import com.camstarts.imageslider.library.transformers.ForegroundToBackgroundTransformer;
import com.camstarts.imageslider.library.transformers.RotateDownTransformer;
import com.camstarts.imageslider.library.transformers.RotateUpTransformer;
import com.camstarts.imageslider.library.transformers.StackTransformer;
import com.camstarts.imageslider.library.transformers.TabletTransformer;
import com.camstarts.imageslider.library.transformers.ZoomInTransformer;
import com.camstarts.imageslider.library.transformers.ZoomOutSlideTransformer;
import com.camstarts.imageslider.library.transformers.ZoomOutTransformer;
import com.camstarts.imageslider.library.tricks.FixedSpeedScroller;
import com.camstarts.imageslider.library.tricks.InfinitePagerAdapter;
import com.camstarts.imageslider.library.tricks.InfiniteViewPager;
...
public class ImageSliderLayout extends RelativeLayout{
    ...
    /**
     * {@link com.camstarts.imageslider.library.tricks.ViewPagerEx} indicator.
     */
    private PagerIndicator mIndicator;


    /**
     * A timer and a TimerTask using to cycle the {@link com.camstarts.imageslider.library.tricks.ViewPagerEx}.
     */
    private Timer mCycleTimer;
    private TimerTask mCycleTask;

    /**
     * For resuming the cycle, after user touch or click the {@link com.camstarts.imageslider.library.tricks.ViewPagerEx}.
     */
    private Timer mResumingTimer;
    private TimerTask mResumingTask;

    /**
     * If {@link com.camstarts.imageslider.library.tricks.ViewPagerEx} is Cycling
     */
    private boolean mCycling;

    /**
     * Determine if auto recover after user touch the {@link com.camstarts.imageslider.library.tricks.ViewPagerEx}
     */
    ...
    /**
     * {@link com.camstarts.imageslider.library.tricks.ViewPagerEx} transformer time span.
     */
    ...
    /**
     * Visibility of {@link com.camstarts.imageslider.library.indicators.PagerIndicator}
     */
    private PagerIndicator.IndicatorVisibility mIndicatorVisibility = PagerIndicator.IndicatorVisibility.Visible;

    /**
     * {@link com.camstarts.imageslider.library.tricks.ViewPagerEx} 's transformer
     */
    private BaseTransformer mViewPagerTransformer;

    /**
     * @see com.camstarts.imageslider.library.animations.BaseAnimationInterface
     */
    private BaseAnimationInterface mCustomAnimation;

    /**
     * {@link com.camstarts.imageslider.library.indicators.PagerIndicator} shape, rect or oval.
     */
     ...
     * {@link com.camstarts.imageslider.library.animations.BaseAnimationInterface},
     * and you can see a example in {@link com.camstarts.imageslider.library.animations.DescriptionAnimation}
     * @param animation
     */
    ...
    /**
     * get the {@link com.camstarts.imageslider.library.indicators.PagerIndicator} instance.
